...
1. 요구사항
   ...
   기업의 정보는 사용자 정보와 기업의 정보, 결제한 카드의 정보 모두 필요하며,
   상품의 정보도 필요합니다. 상품의 정보는 이름, 가격기업 이름, 주소, 대표번호가 있고
   사용자 정보는 이름, 주소, 전화번호가 있습니다. 결제 시 , 재고입니다.
...
-- 요구사항 1 (도서 대여 서비스)
-- 도서관에서 책을 대여하는 서비스입니다.
-- 
-- 도서는 제목, 저자, 출판사가 있습니다.
-- 
-- 회원은 이름, 연락처, 주소 정보를 가집니다.
-- 
-- 회원이 빌린 책의 대여 날짜와 반납 날짜를 기록해야 합니다.
-- 
-- 연체된 책에 대해서는 벌금 정보를 저장할 수 있어야 합니다.

create table tbl_book(
 id bigint unsigned auto_increment primary key,
 book_title char (255) not null,
 book_author char (255) not null,
 book_publisher char (255) not null
);
create table tbl_user(
id bigint unsigned auto_increment primary key,
...
-- 요구사항 2 (음식 배달 서비스)
-- 음식점은 이름, 주소, 전화번호를 가지고 있습니다.
-- 
-- 고객은 이름, 주소, 연락처가 있습니다.
-- 
-- 주문은 고객이 음식점에서 특정 음식을 주문하는 기록이며, 주문 날짜와 배달 상태(배달중, 배달완료 등)를 저장해야 합니다.
-- 
-- 각 음식은 이름, 가격, 음식점 정보를 가지고 있습니다.
-- 
-- 고객은 여러 개의 결제 카드 정보를 저장할 수 있으며, 카드 번호와 카드사 정보가 필요합니다.
